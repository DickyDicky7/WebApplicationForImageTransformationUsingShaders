...
//  uniform vec2 u_patternTiling ; // 1.0, 1.0
    ...
    uniform sampler2D pencil0; // null
//  uniform sampler2D pencil0; // null
...
//  vec2 patternUV4 = (vec2( uv.x, -uv.y) + vec2(0.4123, 0.7218)) * u_patternTiling;
    vec4 pCol1 = texture(pencil1, patternUV1);
//  vec4 pCol1 = texture(pencil1, patternUV1);
    vec4 pCol2 = texture(pencil1, patternUV2);
//  vec4 pCol2 = texture(pencil1, patternUV2);
    vec4 pCol3 = texture(pencil1, patternUV3);
//  vec4 pCol3 = texture(pencil1, patternUV3);
    vec4 pCol4 = texture(pencil1, patternUV4);
//  vec4 pCol4 = texture(pencil1, patternUV4);
...
//  float   intensity =                         getIntensity(origColor.rgb);
    vec4      bgColor =                                                    mix(texture(pencil0, vTexCoord * u_bgTiling), u_bgColor, u_bgColorFactor);
//  vec4      bgColor =                                                    mix(texture(pencil0, vTexCoord * u_bgTiling), u_bgColor, u_bgColorFactor);
