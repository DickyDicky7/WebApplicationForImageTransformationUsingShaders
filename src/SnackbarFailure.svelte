...
<!--<div class="snackbar red10 white-text slow-ripple" id="snackbar-failure"><div class="max white-text">{global.globalState.failureScript}</div><i class="fa-solid fa-lightbulb white-text"></i></div>-->
    <div class="snackbar red10 white-text slow-ripple" id="snackbar-failure"><div class="max white-text">{global.globalState.failureScript}</div><i class="fa-solid fa-lightbulb white-text"></i></div>
<!--<div class="snackbar red10 white-text slow-ripple" id="snackbar-failure"><div class="max white-text">{global.globalState.failureScript}</div><i class="fa-solid fa-lightbulb white-text"></i></div>-->
